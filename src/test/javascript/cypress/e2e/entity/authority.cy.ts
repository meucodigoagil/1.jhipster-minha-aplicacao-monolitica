...
describe('Authority e2e test', () => {
  ...
  const authoritySample = { name: 'd516e9bc-d70c-48a7-94c5-d891ef6fb8ee' };
  ...
  describe('new Authority page', () => {
    ...
    it('should create an instance of Authority', () => {
      cy.get(`[data-cy="name"]`).type('e4ebbce8-a81d-4676-94d5-19e2d4a4ee20');
      cy.get(`[data-cy="name"]`).should('have.value', 'e4ebbce8-a81d-4676-94d5-19e2d4a4ee20');
